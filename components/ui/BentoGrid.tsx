...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 mg:grid-row-7 gap-4 lg:gap-8 mx-auto",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('eellerstein@gmail.com');
  ...
  return (
    ...
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        <div className={cn(
          titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relatvie md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10'
        )}>
